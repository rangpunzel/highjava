...
public class HorseRaceExam {
	...
	public static List<Horse1> hList = new ArrayList<Horse1>();

	public static void main(String[] args) {
		
		hList.add(new Horse1("01번말"));
		hList.add(new Horse1("02번말"));
		hList.add(new Horse1("03번말"));
		hList.add(new Horse1("04번말"));
		hList.add(new Horse1("05번말"));
		hList.add(new Horse1("06번말"));
		hList.add(new Horse1("07번말"));
		hList.add(new Horse1("08번말"));
		hList.add(new Horse1("09번말"));
		hList.add(new Horse1("10번말"));
