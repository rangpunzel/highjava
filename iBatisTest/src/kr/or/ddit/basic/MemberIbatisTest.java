...
public class MemberIbatisTest {
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 실핼할 SQL문에 맞는 쿼리문을 호출해서 원하는 작업을 수행한다.
...
/*			// 2-3 delete 연습
		...
		/*	// 2-4. select 연습
			// 1) 응답의 결과가 여러개일 경우
			System.out.println("select연습시작 (결과가 여러개인 경우)...");
			...
			// 응답결과가 1개가 확실할 경우 에는 queryForObject메서드를 사용한다.
